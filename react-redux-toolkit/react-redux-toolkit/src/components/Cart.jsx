...
function Cart() {
	...
	return (
		<div className="min-h-screen flex items-center justify-center text-zinc-300">
			<div className="mt-20 flex justify-between max-w-7xl w-full flex-wrap">
				{cart.length > 0 &&
					cart.map((item) => (
						<div
							key={item.id}
							className="w-full max-w-xs my-2 flex flex-col justify-between bg-zinc-600 border border-gray-200 rounded-lg shadow-sm"
						>
							<a href="#">
								<img
									className="p-8 rounded-t-lg w-52 mx-auto"
									src={item.image}
									alt="product image"
								/>
							</a>
